...
3. Fill in the mission parameters:
   - **Goal Directive**: The primary high-level objective (e.g., `Audit the project in the workspace for security vulnerabilities, save a report as security_audit.md, and open a GitHub issue with the summary`).
