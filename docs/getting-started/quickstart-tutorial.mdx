...
- **[Agent Studio Guide](../user-guide/agent-studio)**: Build Multi-Agent Swarms with delegation.
- **[Autonomous Missions](../user-guide/missions)**: Run complex DAG workflows with human approval checkpoints.
- **[Plugins & WASM Extensions](../user-guide/plugins)**: Install sandboxed tools, chat channel bots, and SaaS connectors.
- **[Channels & Omnichannel Messaging](../user-guide/channels)**: Connect your agent to Telegram, Discord, Slack, WhatsApp, or Zalo — including sending workspace files.
- **[Tools & MCP Servers](../user-guide/tools-and-skills)**: Add MCP servers and custom folder-based skills.
