...
ActonOS features a robust automation framework combining **Standard Cron/Interval Triggers** with an **Autonomous Heartbeat Daemon** built in strict alignment with the [OpenClaw Heartbeat Contract](https://docs.openclaw.ai/vi/gateway/heartbeat).
