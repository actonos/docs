...
2. If prompted, enter the **Admin PIN** you configured during onboarding.
...
- **[Channels](../user-guide/channels)**: Connect your agent to Telegram, Discord, and Slack.
- **[Tool Hub](../user-guide/tool-hub)**: Install community MCP servers and WASM tools.
