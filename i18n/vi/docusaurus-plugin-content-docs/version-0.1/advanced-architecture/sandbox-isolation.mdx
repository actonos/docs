...
graph TD
    ...
    subgraph "Cách ly Cấp Hệ điều hành (bwrap + Cgroups v2)"
        D["Mount Namespaces:<br/>• /usr, /lib, /bin -> Read-Only<br/>• /proc -> Procfs Biệt lập<br/>• /workspace -> Giới hạn Read-Write"]
...
- **Truy cập Workspace**: Thư mục ghi duy nhất là `/data/workspace` (hoặc phạm vi đường dẫn cấp cho agent).
