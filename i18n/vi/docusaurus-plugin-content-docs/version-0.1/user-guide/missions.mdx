...
3. Nhập thông tin nhiệm vụ:
   - **Chỉ thị Mục tiêu**: Mô tả mục tiêu cấp cao (ví dụ: `Quét mã nguồn /workspace/src tìm lỗ hổng bảo mật, tạo báo cáo đầy đủ tại /workspace/docs/security_audit.md và mở một Issue trên GitHub tóm tắt kết quả`).
