...
```mermaid
flowchart LR
    A["Tải file ISO<br/>ActonOS-v1.iso"] --> B["Ghi vào USB<br/>Rufus / BalenaEtcher / dd"]
...
3. Bấm **Select** và chọn file `ActonOS-v1-amd64.iso`.
...
2. Chọn **Flash from file** và duyệt đến file `ActonOS-v1-amd64.iso`.
